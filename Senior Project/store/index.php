	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			<div class="navbar-header">
				...
				<a href="../index.html" class="navbar-brand">Last Resort</a>
			</div>
							...
							<div class="">
								...
								<div class="panel-heading">
									<form onsubmit="return false" id="login">
										...
										<p><br/></p>
										<a href="#" style="color: #eb3812; list-style:none;">Forgot Password</a><input type="submit" class="btn btn-success" style="float:right;"> <br>
										<a href="/store/customer_registration.php?register=1" style="color:#eb3812; list-style:none;">Create Account</a>
									</form>
								</div>
		...
		<div class="row">
			...
			<div class="col-md-8 col-xs-12">
				...
				<div class="panel panel-info">
					...
					<div class="panel-footer">&copy; Last Resort 2018</div>
				</div>
			</div>
			<div class="col-md-1"></div>
		</div>
